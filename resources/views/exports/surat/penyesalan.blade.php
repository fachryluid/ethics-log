...
@section('title', 'SURAT PERNYATAAN PENYESALAN')
@push('css')
	<style>
		.content p {
			line-height: 1.5;
...
@section('content')
	...
	<div style="text-align: center; margin-bottom: 30px;">
		<div style="margin-bottom: 10px;">PENYESALAN</div>
	...
	<div style="margin-bottom: 60px; list-style-type: none;">
		...
		<p style="margin-bottom: 20px; text-align: justify;">
			dengan ini merasa menyesal atas perbuatan saya berupa {{ $violation->desc }}
