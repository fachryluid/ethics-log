...
class StoreViolationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'department' => 'required',
            'type' => 'required',
            'regulation_section' => $role === UserRole::ADMIN ? 'required' : 'nullable',
            'regulation_letter' => $role === UserRole::ADMIN ? 'required' : 'nullable',
            'regulation_number' => $role === UserRole::ADMIN ? 'required' : 'nullable',
            'regulation_year' => $role === UserRole::ADMIN ? 'required' : 'nullable',
            'regulation_about' => $role === UserRole::ADMIN ? 'required' : 'nullable',
            'date' => 'required|date',
            'place' => 'required',
